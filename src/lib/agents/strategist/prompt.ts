...
- Each option must be a bounded experiment with a plain-language approach, hypothesis, primary metric, success threshold, stop condition and review trigger.
...
Return a candid verdict followed by exactly three concise strategic experiments. Do not create three cosmetic variations of the same tactic. If no product selector was supplied, choose products only when the assignment and catalogue evidence make the choice unambiguous.`;
}
